...
<div id="carouselExampleIndicators" class="carousel slide mt-5" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="../assets/images/pages/car-1.jpeg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="../assets/images/pages/car-2.jpeg" class="d-block w-100" alt="...">
        </div>
    </div>
</div>
        ...
        <?php foreach ($produk as $value) : ?>
            <div class="col-md-2 card-produk shadow-sm m-1  bg-white">
                ...
                <div class="d-flex justify-content-around p-2 w-75 border-top m-auto">
                    <a href="detail.php/?id=<?= $value->id_produk ?>" class="btn btn-sm btn-info mr-1 ">Detail</a>
...
<div class="row bg-light my-5 p-3" style="margin: 0 -50px">
    <div class="col">
        ...
        <div class="d-flex w-100">
            <img class="w-100" src="../assets/images/pages/ban1.jpg" alt="">
            <img class="w-100" src="../assets/images/pages/ban3.png" alt="">
            <img class="w-100" src="../assets/images/pages/ban2.jpg" alt="">
            <img class="w-100" src="../assets/images/pages/ban4.png" alt="">
        </div>
    </div>
</div>
